...
parser.add_argument("--checkpoint_path", "-p", help="path to save checkpoint", default=r"C:\Users\keela\Documents\Models\Stage2Models\Basic_CCE")
parser.add_argument("--mode", "-m", help="enter train, test, or traintest to do both", default="test", type=str)
parser.add_argument("--max_iou", "-i", help="max iou", default=.3, type=float)
parser.add_argument("--min_confidence", "-c", help="min confidence", default=.15, type=float)
